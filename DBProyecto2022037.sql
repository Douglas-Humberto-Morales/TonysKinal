...
call sp_CrearPlato(71,'Pizza','Hamburgesas de toro',10,2);
call sp_CrearPlato(38,'Pizza','Pizza vegana',79,3);
call sp_CrearPlato(5,'Pizza','Obleas',90,4);
call sp_CrearPlato(92,'Pizza','Dobladas',42,5);
call sp_CrearPlato(77,'Pizza','Caldo de res',84,6);
call sp_CrearPlato(21,'Pizza','Caldo de pollo',71,7);
call sp_CrearPlato(38,'Pizza','Pan con jamon',21,8);
call sp_CrearPlato(68,'Pizza','Shucos que estan limpios',58,9);
call sp_CrearPlato(34,'Pizza','Pan con salchicha',64,10);
-- Actualizar Plato
Delimiter $$
