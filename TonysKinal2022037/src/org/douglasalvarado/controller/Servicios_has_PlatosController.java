    ...
    public void seleccionarElemento(){
        if (selecionar) {
            if (tblServicios_has_Platos.getSelectionModel().getSelectedItems() != null) {
                ...
                cmbPlato.getSelectionModel().select(
                        String.valueOf(((Servicios_has_Platos)tblServicios_has_Platos.getSelectionModel().getSelectedItem()).getCodigoPlato()));
                cmbServicio.getSelectionModel().select(
                        String.valueOf(((Servicios_has_Platos)tblServicios_has_Platos.getSelectionModel().getSelectedItem()).getCodigoServicio()));
            }
        }
    }
